function counterUp(t) {
    ...
    for (var r in this.defaults)
        "undefined" != typeof r && (e.props[r] = e.defaults[r],
...
counterUp.prototype.update = function() {
    ...
    this.elems.forEach(function(e) {
        e.val += e.step,
        e.val < e.end ? (1 == e.intvalues ? e.obj.innerHTML = e.prepend + Math.floor(e.val).toString() + e.append : e.obj.innerHTML = e.prepend + (Math.round(100 * e.val) / 100).toString() + e.append,
        t = !1) : e.obj.innerHTML = e.prepend + e.end.toString() + e.append
    }),
